...
public class AwardModel<R> {
  ...
  public AwardModel(IEngine<R> engine) {
  ...
  private List<Game> _loadGames(R root, ListModel<Game> model) {
...
//      return decodeBase64ToByte((o instanceof Game) ? ((Game)o).getImage() : ((Award)o).getImage());
  ...
  private void _saveGames(List<Game> games, R root, Mode mode) {
  ...
  private boolean _saveGame(Game game, R root, Mode mode) {
...
//        }
  ...
  public List<Game> loadGames(R dir) {
  ...
  public void exportGames(List<Game> games, R root) {
